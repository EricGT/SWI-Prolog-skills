...
**Description:** Build and test SWI-Prolog with MSVC on Windows. Automates MSVC environment setup, CMake configuration, compilation, and testing across Release, Debug, RelWithDebInfo, MinSizeRel, and Sanitize configurations.
...
**Quick Start:**
```bash
/swipl-build build Release              # Build Release configuration
